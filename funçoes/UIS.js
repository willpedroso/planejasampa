...
var UIS = {
    ...
    configListeners: function () {
	    ...
	    this.bt_Subprefeituras.bind("touchstart click", (function () {
	    ...
	    // Botão voltar
	    this.bt_Voltar.bind("touchstart click", (function () {
	    ...
	    this.bt_showMetasObjetivos.bind("touchstart click", (function () {
	    ...
	    this.bt_showMetasStatus.bind("touchstart click", (function () {
	    ...
	    this.bt_Configure.bind("touchstart click", (function () {
	    ...
	    this.atualizacaoDados.bind("touchstart click", (function () {
	    ...
	    this.termosUso.bind("touchstart click", (function () {
	    ...
	    this.desenvolvimento.bind("touchstart click", (function () {
	    ...
	    this.ul_ListaMetasStatus.bind("touchstart click", (function (event) {
	    ...
	    this.ul_listaObjetivos.bind("touchstart click", (function (event) {
	    ...
	    this.ul_ListaMetas.bind("touchstart click", (function (event) {
	    ...
	    this.ul_DetalhesMeta.bind("touchstart click", (function (event) {
	        alert("Detalhes da meta");
	...
	showListaMetas: function(dados) {
	    ...
	    for (var i = 0; i < dados.rows.length; i++) {
	        nodes += "<li><div idMeta='" + dados.rows.item(i).ID_META + "'>" + dados.rows.item(i).NAME_META + "</div></li>";
        }
//	    alert(nodes);
...
//	    alert(nodes);
	...
	fillDivStatusGoals: function(dados) {
	    ...
	    var nodes = "";
	    for (var i = 0; i < dados.rows.length; i++) {
	        nodes += "<li><div idRegistro='" + dados.rows.item(i).STATUS_META + "'>" + "Status = " + UIS.txtStatusMetas[dados.rows.item(i).STATUS_META] + " - Qtd = " + dados.rows.item(i).QTD + "</div></li>";
	    }
//	    alert(nodes);
